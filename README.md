...
Retrieval — BM25 + dense cosine, cross-encoder reranking (all client-side JS)
Generation & Evaluation — Anthropic Claude API (claude-sonnet-4-20250514)

Toggles
ToggleEffectHyDEHypothetical document expansion before retrievalRerankingCross-encoder precision pass on retrieved chunksFaithfulnessPost-generation grounding scoreShow TracePer-response log of what each stage returned
